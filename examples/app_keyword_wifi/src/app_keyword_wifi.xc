...
on tile[0]: in port p_pdm_clk               = PORT_MIC_CLK;
on tile[0]: in buffered port:32 p_pdm_mics  = PORT_MIC_DATA;
on tile[0]: in port p_mclk                  = PORT_MCLK_TILE0;
    ...
    par{
        on tile[0]:{
            ...
            par{
                ...
                [[distribute]] i2c_master(i2c, 1, p_i2c_scl, p_i2c_sda, 100);
            }
        }
    }
    return 0;
